                    ...
                    <?php
                        if(isset($_GET['id']) && !empty($_GET['id']))    {
                            ...
                            if(mysqli_num_rows($entrer) > 0){
                                ...
                                <input type="text" value="<?= $item['Adresse_Fournisseur'] ?>" name="AdresseFournisseur" required>

                                <label>E-mail Fournisseur: </label>
                                <input type="email" value="<?= $item['Email_Fournisseur'] ?>" name="emailFournisseur" required>

                                <label>Tél Fournisseur: </label>
                                <input type="number" value="<?= $item['Tel_Fournisseur'] ?>" name="telFournisseur" required>
