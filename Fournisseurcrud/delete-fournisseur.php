<?php
    ...
    if (isset($_POST["delete"]) && isset($_GET["id"])) {
        ...
        $stmt = $con->prepare("DELETE FROM fournisseurs WHERE id = ?");
...
<html lang="fr">
    ...
    <div class="container">
        ...
        <?php
            ...
            if ($id !== null) : 
        ?>
            <p>Êtes-vous sûr de vouloir supprimer l'administrateur <?php echo $id; ?>?</p>
            <form action="<?php echo $_SERVER["PHP_SELF"]; ?>?id=<?php echo $id; ?>" method="post">
                <input type="hidden" name="id" value="<?php echo $id; ?>">
                <input type="submit" name="delete" value="Oui, supprimer">  <!-- Bouton pour confirmer la suppression -->
                <a href="../Fournisseurs.php">Non, annuler</a>   <!-- Lien pour annuler et retourner à la liste des utilisateurs -->
            </form>
        <?php 
            endif; 
        ?>
